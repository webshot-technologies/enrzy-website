...
const HeroBanner: React.FC<HeroBannerProps> = ({ className = '' }) => {
  ...
  useEffect(() => {
    ...
    // --- FINAL REVISED: Correctly targeting all new text elements ---
    ...
    scrollTl
      ...
      .to([headingLines, textRef.current], {
    ...
    <div className={`relative h-screen overflow-hidden ${className}`} ref={bannerWrapRef}>
      ...
      <div
        ...
        style={{
          ...
          backgroundImage: isMobile
            ...
            ? 'url(https://aereo.io/wp-content/themes/Aereo/assets/img/mob-white-bg.png)'

            : 'url(https://aereo.io/wp-content/themes/Aereo/assets/img/home-white-bg.svg)',
      ...
      >
        ...
        <source
          ...
          src={isMobile ? "/assets/enrzy.mp4" : "/assets/enrzy.mp4"}
